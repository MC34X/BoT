...
cl = LINE("ufe7131aeb3bd6c7a88a1580db7f34b48:aWF0OiAxNTgwMjQzOTYyMjE1Cg==..0no3Ahz+GY5lpSnsG3a1Aq/thrM=")
cl.log("Auth Token : " + str(cl.authToken))

ka = LINE("u1b7a66e0e36b1cc4f2766668ea9a3003:aWF0OiAxNTgwMjQwOTY0NTMwCg==..BqWxsBIm6i0iUh0qLIXq1KA++jk=")
ka.log("Auth Token : " + str(ka.authToken))

kb = LINE("u02320e7bb63b2d76a4d6819ecb85f2c0:aWF0OiAxNTgwMTU1NjczNzc0Cg==..G60JywAmuGEV4C4PjoOViUvt02o=")
kb.log("Auth Token : " + str(kb.authToken))

kc = LINE("u1b5cbe0b0b5c02f3150fa8d64c029ec3:aWF0OiAxNTgwMTU1Mzg2MDUwCg==..luJdfO5KEmj/KffT/dOYJCnGPWc=")
kc.log("Auth Token : " + str(kc.authToken))

kd = LINE("u2d5ca952cd87a328f6e9f87bef944052:aWF0OiAxNTkxNjE1ODQ5MjM4Cg==..bK4oMGJt/0xkh1XXc6F2WJ+4ylQ=")
kd.log("Auth Token : " + str(kd.authToken))

ke = LINE("uf578d543aa33f98994fa2603f216d0c1:aWF0OiAxNTkxNjIxNTUxMzI5Cg==..ozZqAR0vrU7VKaAeOfJN0MmSrRY=")
ke.log("Auth Token : " + str(ke.authToken))

kf = LINE("u25f6347931580f5595b3c3ed0850ef29:aWF0OiAxNTkxNjcwNzQ4NjQ5Cg==..sxfqK7QRFTed5539ScFCsECdynE=")
kf.log("Auth Token : " + str(kf.authToken))

k1 = LINE("u3c8c5ec5eedd5b02b987b849174cf556:aWF0OiAxNTkxNjcyMTQyMzY1Cg==..ia/WwaaIGN7NTWa48os/0NTLYC8=")
...
creator = [
    "u93e7efe388a1554b28e59668f7324346"
    ]
...
#--------------------------------------------------------
                  ...
                  if msg._from in creator or msg._from in org["owner"] or msg._from in org["admin"]:
                    ...
                    with open('pro.json', 'w') as fp:
                        json.dump(pro, fp, sort_keys=True, indent=4)
                    cl.sendMessage(msg.to," 𝐏𝐫𝐨𝐭𝐞𝐜𝐭𝐢𝐨𝐧 𝐂𝐚𝐧𝐜𝐞𝐥 𝐨𝐧")
